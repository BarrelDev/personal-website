      ...
      <div className="container-fluid bg-dark" id="home">
        <div className="container col-xxl-8 px-4 py-5 ">
          <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div className="col-10 col-sm-8 col-lg-6 border border-3 rounded-5 shadow pt-3">
              <img
                src={logo}
            ...
            <div className="col-lg-6">
              ...
              <h1 className="display-5 fw-bold text-white text-body-light lh-1 mb-3">
                Visvam Rajesh
              </h1>
              <h1 className="display-5 fw-light text-white fs-2 text-body-light lh-1 mb-3">
